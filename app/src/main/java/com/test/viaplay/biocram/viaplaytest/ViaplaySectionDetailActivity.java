...
/**
 * An activity representing a single ViaplaySection detail screen. This
...
public class ViaplaySectionDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ViaplaySectionDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(ViaplaySectionDetailFragment.ARG_ITEM_ID));
