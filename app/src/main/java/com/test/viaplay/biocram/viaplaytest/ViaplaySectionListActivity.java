...
import com.test.viaplay.biocram.viaplaytest.dummy.DummyContent;
 ...
 */
public class ViaplaySectionListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.viaplaysection_list);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(ViaplaySectionDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(ViaplaySectionDetailFragment.ARG_ITEM_ID, holder.mItem.id);
